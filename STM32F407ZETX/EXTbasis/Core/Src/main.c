...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOF, LED_D1_Pin|LED_D0_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LED_D1_Pin LED_D0_Pin */
  GPIO_InitStruct.Pin = LED_D1_Pin|LED_D0_Pin;
